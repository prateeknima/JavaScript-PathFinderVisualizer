...
function minHeap() {
	...
	this.getMin = function(){
		...
		console.log("Before pop heap is: " + JSON.stringify(this.heap));
		this.heap.pop();
		console.log("After pop heap is: " + JSON.stringify(this.heap));
		if (!this.isEmpty()){
			this.siftDown(0);
		}
		console.log("After shift heap is: " + JSON.stringify(this.heap));
		return min;
	}
	...
	this.siftDown = function(index){
		...
		console.log("Heap after siftdown is: " + JSON.stringify(this.heap));
...
$( "td" ).mousedown(function(){
	...
	if ( !inProgress ){
		...
		if (index == startCellIndex){
			movingStart = true;
			console.log("mousedown Now moving start!");
			//console.log("Now moving start!");
		} else if (index == endCellIndex){
			movingEnd = true;
			console.log("mousedown Now moving end!");
		} else {
			createWalls = true;
			console.log("mousedown Creating Walls!");
